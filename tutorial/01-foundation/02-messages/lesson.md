...
⚙️ System: "You are helpful"
   │
   ├→ Human: "What's 2+2?"
   │
   ├→ AI: "Let me calculate..."
   │  └─ [Tool Call: calculator(2, 2)]
   │
   ├→  Tool: "4"
   │
   └→ AI: "2+2 equals 4"
...
➡️ [Continue to Lesson 3: The LLM Wrapper](03-llm-wrapper.md)
...
[← Previous: Runnable](01-runnable.md) | [Tutorial Index](../README.md) | [Next: LLM Wrapper →](03-llm-wrapper.md)